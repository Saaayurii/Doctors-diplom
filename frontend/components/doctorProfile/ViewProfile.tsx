...
function ViewProfile() {
  ...
  const profileFields = [
    ...
    { name: "residenceCountry", title: "Страна проживания" },
    { name: "specialization", title: "Специализация" },
    { name: "languages", title: "Языки" },
    { name: "thirtyMinPrice", title: "Цена за 30 минут" },
    { name: "sixtyMinPrice", title: "Цена за 60 минут" },
  ];
  ...
  return (
    <div className="m-4">
      ...
      >
        ...
        <p className="text-green-500 underline">Редактировать профиль</p>
      </Link>
    </div>
  );
}

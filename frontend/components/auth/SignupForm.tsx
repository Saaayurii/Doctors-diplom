...
function SignUpForm() {
  ...
  const formFields = [
    ...
    { name: "confirmPassword", title: "Подтвердите пароль", type: "password" },
    ...
    <div className="p-5 rounded-xl max-w-md m-auto h-screen overflow-y-hidden hover:overflow-y-scroll">
      ...
      <div className="flex gap-8 items-center justify-center my-2">
        <div className="flex flex-col gap-2 items-center">
          ...
          />
          <p className={patientTextClass}>Пациент</p>
        </div>
        <div className="flex flex-col gap-2 items-center">
          <Image
            src={doctorImage}
          ...
          />
          <p className={doctorTextClass}>Врач</p>
        </div>
      </div>
                ...
                <>
                  ...
                  <div className="calendar-container relative ">
                    <Calendar
                      ...
                      showIcon
                      dateFormat="yy-mm-dd"
                      placeholder="Выберите дату рождения (гггг-мм-дд)"
                      maxDate={new Date()}
                      yearRange="1900:2023"
            ...
            <div className="mb-4 relative border-2 border-blue-400 rounded-lg">
              <div className="flex justify-between items-center mb-3 p-3">
                ...
                >
                  ...
                  <p className="text-green-500 font-bold">Добавить сертификат</p>
                </button>
                <p className="font-semibold text-xl">Сертификаты</p>
              </div>
              {doctorCertificates.map((certificate) => {
                return (
                  ...
                  >
                    ...
                    />
                    <InputComponent
                      label="Орган выдачи сертификата"
                      type="text"
                      name="authority"
                      placeholder={
                        "Введите орган выдачи сертификата №" +
                        (certificate.id + 1)
                      }
                    ...
                    />
                    <InputComponent
                      label="Дата начала сертификата"
                      type="text"
                      name="startDate"
                      placeholder={
                        "Введите дату начала сертификата №" +
                        (certificate.id + 1)
                      }
                    ...
                    <InputComponent
                      ...
                      name="endDate"
                      placeholder={
                        "Введите дату окончания сертификата №" +
                        (certificate.id + 1)
                      }
            ...
            <div className="mb-4 relative border-2 border-blue-400 rounded-lg">
              <div className="flex justify-between items-center mb-3 p-3">
                ...
                >
                  ...
                  <p className="text-green-500 font-bold">Добавить опыт работы</p>
                </button>
                <p className="font-semibold text-xl">Опыт работы</p>
              </div>
                ...
                return (
                  ...
                  >
                    <InputComponent
                      ...
                      name="title"
                      placeholder={
                        "Введите должность опыта работы №" +
                        (experience.id + 1)
                      }
                    ...
                    <InputComponent
                      ...
                      name="firm"
                      placeholder={
                        "Введите название организации опыта работы №" +
                        (experience.id + 1)
                      }
                    ...
                    <InputComponent
                      ...
                      name="department"
                      placeholder={
                        "Введите отделение опыта работы №" +
                        (experience.id + 1)
                      }
                    ...
                    <InputComponent
                      ...
                      name="startDate"
                      placeholder={
                        "Введите дату начала опыта работы №" +
                        (experience.id + 1)
                      }
                    ...
                    <InputComponent
                      ...
                      name="endDate"
                      placeholder={
                        "Введите дату окончания опыта работы №" +
                        (experience.id + 1)
                      }
            ...
            <div className="mb-4 relative border-2 border-blue-400 rounded-lg">
              <div className="flex justify-between items-center mb-3 p-3">
                ...
                >
                  ...
                  <p className="text-green-500 font-bold">Добавить интерес</p>
                </button>
                <p className="font-semibold text-xl">Интересы</p>
              </div>
                ...
                return (
                  ...
                  >
                    <InputComponent
                      ...
                      name="name"
                      placeholder={
                        "Введите название интереса №" + (interest.id + 1)
                      }
                      value={interest.name}
                    ...
                    >
                      ...
                      <p className="text-red-500 font-bold">Удалить интерес</p>
                    </button>
                  </div>
                );
              })}

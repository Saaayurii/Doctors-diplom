    ...
    <section className="h-screen flex flex-col-reverse md:flex md:flex-row md:ml-[12.5%]">
      <div className="flex flex-col h-full space-y-4">
        <div className="flex flex-col p-2 space-y-6">
          <p className="text-xs text-[#343a40] font-light">ВЫ ГОВОРИТЕ МЫ ПОМОГАЕМ</p>
          <h1 className="text-black text-5xl md:text-6xl font-light">
            Общайтесь{" "}
            <span className="font-bold">с вашим врачом онлайн конфиденциально </span>{" "}
            в любое время в любом месте!
          </h1>
          <p className="text-base md:text-lg font-semibold text-[#343a40]">
            TeleMedPilot - лидер в онлайн телемедицине во всём мире.
          </p>
        </div>
